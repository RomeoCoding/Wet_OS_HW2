...
OBJS = main.o account.o atm.o bank.o logger.o procedure_handler.o error_handler.o status_snapshot.o vip_thread_pool.o vip_function.o
EXEC = bank
...
main.o: main.cpp account.hpp atm.hpp bank.hpp logger.hpp procedure_handler.hpp status_snapshot.hpp
...
bank.o: bank.cpp bank.hpp account.hpp atm.hpp logger.hpp procedure_handler.hpp status_snapshot.hpp vip_thread_pool.o
...
vip_function.o: vip_function.cpp vip_function.hpp
	$(CXX) $(CXXFLAGS) -c -o vip_function.cpp
# Clean up old files
clean:
	$(RM) $(EXEC) $(OBJS) *~ core.*
